...
object Day13Inheritance extends App {
  ...
  myCar.move() // so I Inherited the ability to move from the com.github.ValRCS.Vehicle parent/super class
  ...
  newTeacher.teach()
  println(newTeacher) //just like com.github.ValRCS.Student I still have access to pretty print since super class was in fact a case class
