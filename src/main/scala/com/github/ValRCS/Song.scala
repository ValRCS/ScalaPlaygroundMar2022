...
//  }
  ...
  def sing(maxLines: Int = -1):Song= {
    ...
    this //so we return a com.github.ValRCS.Song itself then we can chain the next command
  }
...
class Rap(title:String, author:String, lyrics: Seq[String])
  ...
  //now any com.github.ValRCS.Rap will have access to ALL com.github.ValRCS.Song methods and values /fields
