...
import com.github.ValRCS.Fingers.Finger
//more examples here
...
//notice object so singleton meaning we only have one com.github.ValRCS.Color object
...
object Fingers extends Enumeration {
  type Finger = Value //so all com.github.ValRCS.Fingers have same type of Value
...
object Day16Enumerations extends App {
  ...
  println("How about the com.github.ValRCS.Fingers?")
