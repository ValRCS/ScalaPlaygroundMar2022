...
object Day20CSVExerciseSolved extends App {
  ...
  val lettucePriceRounded = Util.myRound(averagePriceOfLettuce, 2)
  ...
  val roundedAverageHead = Util.myRound(lettuceHeadAveragePrice, 2)
  ...
  val roundedAverageTwin = Util.myRound(lettuceTwinAveragePrice,2)
